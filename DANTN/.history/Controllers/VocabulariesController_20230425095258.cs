...
namespace DANTN.Controllers
{
  ...
  public class VocabulariesController : ControllerBase
  {
    ...
    public async Task<IActionResult> GetVocabulariesByTopicId(string topicId)
    {
      var vocabularies = await _context.Vocabularies.Where(v => v.TopicId == topicId).ToListAsync();
    }
  }
