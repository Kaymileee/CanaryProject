...
const LoginPage = () => {
  ...
  return (
    <>
      {/* <div className="w-full max-w-[800px] mx-auto bg-white rounded-lg flex flex-col items-center">
      <div className="flex flex-col items-start w-full gap-2">
        <label htmlFor="username">User name</label>
        <input
          type="text"
          id="username"
          className="outline-none w-full max-w-[400px] rounded-lg p-3"
          placeholder="Enter your username"
          autoComplete="off"
          onChange={(e) => setUser({ ...user, userName: e.target.value })}
        />
      </div>
      <div className="flex flex-col items-start gap-2 full">
